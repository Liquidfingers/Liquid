...
This Project was named as __'Journey to the Dashboard'__ When i saw how large the data was i decided to make the whole stuff to be as simple as possible see to understand
i adopted visualization as a means to relay the information and my findings from this project. The market is an ideal market affected by the forces of demand and supply<br/>
...
But when it came to hypothetical analysis i need to remove the duplicates. At this point i had to adopt the ```groupby``` keyword to execute this and it worked. When you check the code,
...
Basically what i wanted was for the name that was duplicated to be one and all the goods should be listed and the prices summed up so it will look like a list or record. It worked but I could not tamper much with the
